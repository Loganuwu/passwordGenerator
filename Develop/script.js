...
// --------------------------------PROMPT MESSAGES AND INPUTS ABOVE--------------------------------------------
  ...
  // FOR LOOP BEGINS TO START ADDING EACH RANDOM CHARACTER INTO AN INDEX
    for (let i =0; i < passLength; i++){
       ...
       for (let k = 0; k <= 2; k++) { // nested for loop keeps looping if condition is not met, once the condition of if the input was what we wanted, it stops looping
